...
const Login = {
    ...
    "common.login.username.numericString": "用户名必须为数字字符串！",
...
const CardSale = {
    "cardSale.cardSale.customer":"客户服务",
    "cardSale.cardSale.title":"电子卡销售",
};

const CardSaleForm = {
    "customer.cardSale.cardSaleForm.title":"电子卡信息",
    "customer.cardSale.cardSaleForm.balance":"账户余额",
    "customer.cardSale.cardSaleForm.mobileNumber":"电话",
    "customer.cardSale.cardSaleForm.mobileNumberRule":"电话不能为空",
    "customer.cardSale.cardSaleForm.voucherCard":"电子卡",
    "customer.cardSale.cardSaleForm.voucherCardRule":"电子卡不能为空",
    "customer.cardSale.cardSaleForm.amount":"金额",
    "customer.cardSale.cardSaleForm.amountRule":"金额不能为空",
    "customer.cardSale.cardSaleForm.total":"总金额",
    "customer.cardSale.cardSaleForm.pin":"支付密码",
    "customer.cardSale.cardSaleForm.pinRule":"支付密码不能为空",
    "customer.cardSale.cardSaleForm.successTitle":"成功提示",
    "customer.cardSale.cardSaleForm.successContent":"电子卡销售成功！"
};
