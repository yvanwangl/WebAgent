...
const Login = {
    "common.login.title": "Welcome To Login",
    "common.login.username.label": "Username",
    "common.login.username.vtype": "Username Is Required",
    "common.login.username.numericString": "Username Must Be Numeric String",
...
const CardSale = {
    "cardSale.cardSale.customer":"Customer",
    "cardSale.cardSale.title":"Card Sale",
};

const CardSaleForm = {
    "customer.cardSale.cardSaleForm.title":"Voucher Card Info",
    "customer.cardSale.cardSaleForm.balance":"Balance",
    "customer.cardSale.cardSaleForm.mobileNumber":"Mobile",
    "customer.cardSale.cardSaleForm.mobileNumberRule":"Mobile Is Required",
    "customer.cardSale.cardSaleForm.voucherCard":"Voucher Card",
    "customer.cardSale.cardSaleForm.voucherCardRule":"Voucher Card Is Required",
    "customer.cardSale.cardSaleForm.amount":"Amount",
    "customer.cardSale.cardSaleForm.amountRule":"Amount Is Required",
    "customer.cardSale.cardSaleForm.total":"Total",
    "customer.cardSale.cardSaleForm.pin":"Pay Pin",
    "customer.cardSale.cardSaleForm.pinRule":"Pay Pin Is Required",
    "customer.cardSale.cardSaleForm.successTitle":"Success Message",
    "customer.cardSale.cardSaleForm.successContent":"Sale Success!"
};
